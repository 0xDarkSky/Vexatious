...
with open("sites.txt") as f: #"https://instagram.com", "https://netflix.com", "https://twitter.com", "https://shopify.com", "https://pixabay.com/", "https://target.com/", "https://wired.com/", "https://lainchan.org", "https://libredd.it/", "https://harvard.edu/", "https://forbes.com/", "https://google.com", "https://soundcloud.com", "https://spotify.com", "https://time.com", "https://cloudflare.com", "https://wordpress.org", "https://invidious-us.kavin.rocks", "https://europa.eu"
     content = f.readlines()
     WhiteListLinks = [x.strip() for x in content]
...
def WebOpen():
    try:
        ...
        randUsers = user_agent_Acer, user_agent_Huawei, user_agent_Ipad, user_agent_MacOS, user_agent_Samsung
